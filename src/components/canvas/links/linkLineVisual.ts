export const LINK_RADIO_DASH = '6 5';
/** Linha estrutural fina — fibra contínua, rádio tracejado. */
...
export const LINK_PILL_STROKE = 'rgba(125, 211, 252, 0.88)';
export const LINK_LINE_CAP = { strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const };
